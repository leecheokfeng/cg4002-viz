...
public class MqttReceiver : M2MqttUnityClient
{
    ...
    public string topicSubscribe = "Player 1 Action"; // topic to subscribe. !!! The multi-level wildcard # is used to subscribe to all the topics. Attention i if #, subscribe to all topics. Attention if MQTT is on data plan
    [Tooltip("Set the topic to publish (optional)")]
    public string topicPublish = "Player 1 Visibility"; // topic to publish
    public string messagePublish = "cf_visible_true"; // message to publish
